...
V2 的 46% 包含可复用的 Session、LLM Router、Workspace、Policy、ToolRun、FileEdit、Context Compaction 和 TUI，以及版本化 migration、稳定错误契约、Mission/Run 状态机、自动 Run/Session 绑定、append-only Run Events、活动投影、legacy Task 适配和 CLI 生命周期。Coordinator、结构化任务板、恢复执行和真实 Sandbox 尚未实现。
