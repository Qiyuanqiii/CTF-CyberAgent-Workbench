...
状态：进行中；schema v35 已完成不可变 draft 投影，schema v36 已完成冻结 Artifact Evidence 与一次性 operator 验证/拒绝，schema v37 已完成独立 acceptance、fresh remediation Evidence 与 fix；当前 runtime 已完成 confirmed-unresolved SARIF 与通用 CI gate，平台专用 CI annotations 待后续切片
