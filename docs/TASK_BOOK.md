...
- [ ] Desktop D1（当前产品可用度约 92-94%）：下一批建议 D1-G3 有界 exact-root recent commit/branch history、D1-V2 操作者 verification plan/checklist 与 D1-F3 带 high-water/digest 的 Markdown/JSON Code handoff export；这是新六切片周期的前三片，批末执行普通整合门，再下三片后执行完整健壮性门。
