...
状态：进行中；只读 `skill.v1` Registry、schema v39 Run 选择与 schema v40 root 上下文交付已完成
...
- [ ] 增加 Plan/Delivery 内置 Skill：三方向选择、模块/切片推进、切片审计、交接 Note 与大模块健壮性门禁，复用 WorkItems/Notes。
