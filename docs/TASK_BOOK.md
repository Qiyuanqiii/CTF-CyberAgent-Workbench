...
状态：进行中；schema v21 internal-only Specialist admission 已完成，child 模型执行尚未开放
...
- [ ] 子 Agent 有 Agent identity 绑定的 WorkItem 和可见 Notes。
