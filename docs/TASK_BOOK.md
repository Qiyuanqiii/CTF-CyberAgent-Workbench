...
- [ ] P11-B1/B2/B3：无启动 Chromium/Edge 发现与摘要、一次性 Profile 目录所有权计划、Disabled/Fake CDP transport。
- [ ] P11-C：经独立审批和生命周期审计后才实现 Safe Web 真实启动、导航、DOM 与截图；不得复用 Wails renderer 或个人 Chrome Profile。
