...
- CGO SQLite 驱动 `github.com/mattn/go-sqlite3`，当前 schema 版本为 v56。
...
长对话恢复时依次阅读：`README.md`、`docs/PROJECT_MEMORY.md`、`docs/PROJECT_STATUS.md`、本文件、`docs/TASK_BOOK.md`、`docs/http-api.md`、`docs/errors.md`，再按序阅读 `docs/adr/0001-*.md` 到 `docs/adr/0016-recoverable-docker-rehearsal-attempt.md`。
