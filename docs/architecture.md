...
`LocalSandbox` remains development-only and must use the same approval/event pipeline. It is never treated as an isolation boundary. None of the target-model bullets are execution claims for schemas v48-v61; v51 names required evidence, v52 exercises its shape against fakes, v53 observes only daemon/image metadata, v54 compiles and fake-stages a plan in memory, v55 only creates, inspects, and removes a container that is never started, v56 adds durable recovery, v57 captures a kernel-sealed bundle, v58 makes that choice crash-stable, v59 transfers and reads the bundle back through a temporary daemon-owned volume before deleting every handoff resource, v60 compiles strict per-target projection archives, and v61 applies them to readback-verified volumes attached to a retained but never-started target. None verifies process isolation or a production execution control. Retained-resource lifecycle, start/wait/termination, running-container orphan reconciliation, secret materialization, output Artifact export, and broader network enforcement remain separately gated work. See [ADR 0008](adr/0008-sandbox-manifest-boundary.md), [ADR 0009](adr/0009-sandbox-approval-candidate.md), [ADR 0010](adr/0010-disabled-sandbox-lifecycle.md), [ADR 0011](adr/0011-disabled-sandbox-preflight.md), [ADR 0012](adr/0012-simulation-only-sandbox-evidence.md), [ADR 0013](adr/0013-read-only-docker-observation.md), [ADR 0014](adr/0014-deterministic-docker-container-plan.md), [ADR 0015](adr/0015-bounded-docker-write-rehearsal.md), [ADR 0016](adr/0016-recoverable-docker-rehearsal-attempt.md), [ADR 0017](adr/0017-descriptor-sealed-host-input-staging.md), [ADR 0018](adr/0018-durable-pre-stage-host-input-requirement.md), [ADR 0019](adr/0019-daemon-owned-host-input-handoff.md), [ADR 0020](adr/0020-deterministic-runtime-input-projection.md), and [ADR 0021](adr/0021-recoverable-runtime-input-application.md).
