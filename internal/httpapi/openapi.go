	...
	document := openAPIDocument{
		...
		Info: openAPIInfo{
			...
			Description: "Authenticated loopback-only API owned by the Go control plane. " +
				"Read operations expose durable metadata; the separately authorized control capability permits exact active-call cancellation and selection of a non-authorizing Run execution profile.",
			Version: Version,
