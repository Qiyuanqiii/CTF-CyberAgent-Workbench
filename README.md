...
- **可扩展架构 / Extensible architecture:** Go control plane with a generated OpenAPI 3.1 contract, loopback-only read API, and planned WebSocket, TypeScript UI, Docker sandbox, and Rust analyzer boundaries.
