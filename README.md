...
- **Agent Coordinator:** stable root identity, atomic Run/Supervisor status projection, bounded durable inboxes, payload-integrity hashes, restart-validated graph snapshots, and hard-disabled child spawning.
