...
- **只读 Skill Registry / Read-only Skill Registry:** Go-owned strict `skill.v1` manifests, pinned content hashes, Profile/tool compatibility, bounded embedded content, and deterministic inspection without prompt injection or capability grants.
